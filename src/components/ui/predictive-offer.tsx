...
import { AlertTriangle, Briefcase, Building, Check, CheckCircle, Handshake, DollarSign, MessageSquare, Users } from 'lucide-react'
        ...
        <CardHeader className="pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>
                Data-driven salary negotiation strategy
              </CardDescription>
            </div>
          </div>
        </CardHeader>
    ...
    <div className="w-full">
      {stage === 'calculator' ? (
        <OfferProbabilityCalculator 
          ...
          onPrepareNegotiations={() => setStage('negotiation')}
        />
      ) : (
