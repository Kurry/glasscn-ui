...
import { Download, Copy, Briefcase, Users, Globe, ChevronUp } from 'lucide-react'
      ...
      <Card className="w-full max-w-2xl" variant="glass" blur="lg">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-base">
            Each optimized for different markets
          </CardDescription>
        </CardHeader>
          ...
          {variants.map((variant) => (
            <Card 
              ...
              className={cn(
                ...
                expandedVariant === variant.id ? "shadow-md" : ""
              )}
              variant="solid"
            >
              <div 
  ...
  const variants: ResumeVariant[] = [
    {
      ...
      emphasis: 'Optimized for FAANG and large tech companies. Emphasizes your experience with large-scale systems, algorithmic efficiency, and enterprise architecture.',
    ...
    },
    {
      ...
      emphasis: 'Perfect for startups and growth-stage companies. Focuses on your versatility, ownership mentality, and ability to work across the stack with limited resources.',
    ...
    },
    {
      ...
      emphasis: 'Tailored for fully-remote positions. Highlights your experience with asynchronous communication, self-management, and independent work styles.',
    ...
    },
    {
      ...
      emphasis: 'Designed for team lead and managerial roles. Emphasizes your experience mentoring others, making strategic decisions, and driving team success.',
