...
const twStyles = {
  root: [
    ...
    "disabled:opacity-50 data-[state=checked]:bg-neutral-900 data-[state=checked]:text-neutral-50",
    "dark:border-neutral-800 dark:border-neutral-50 dark:ring-offset-neutral-950",
    "dark:focus-visible:ring-neutral-300 dark:data-[state=checked]:bg-neutral-50",
