...
const twStyles = {
  ...
  content: [
    ...
    "translate-y-[-50%] gap-4 p-6 shadow-lg",
  ...
  close: [
    ...
    "data-[state=open]:bg-gray-100 data-[state=open]:text-neutral-500",
    "dark:ring-offset-neutral-950 dark:focus:ring-gray-300",
    "dark:data-[state=open]:bg-gray-800 dark:data-[state=open]:text-neutral-400",
  ],
...
>(({ className, children, variant, blur, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(dialogContentVariants({ variant, blur }), className)}
      {...props}
    >
      {children}
