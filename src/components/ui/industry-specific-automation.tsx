...
import { Code, Star, GitBranch, Check, Zap, Image } from 'lucide-react'
        ...
        <CardHeader className="pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>
                AI is enhancing your profile with GitHub data
              </CardDescription>
            </div>
            <Badge className="ml-auto animate-pulse bg-green-100 text-green-800 border-green-200">
              Live
            </Badge>
          </div>
        </CardHeader>
        ...
        <CardHeader className="pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>
                AI is updating your resume with portfolio projects
              </CardDescription>
            </div>
            <Badge className="ml-auto animate-pulse bg-green-100 text-green-800 border-green-200">
              Live
          ...
          <div className="p-4 rounded-lg bg-gray-100 dark:bg-gray-800">
            ...
            <div className="grid grid-cols-4 gap-2">
              {projects.map((project) => (
                <div key={project.id} className="relative aspect-square bg-gray-200 dark:bg-gray-700 rounded-md overflow-hidden">
...
export function IndustrySpecificDemo() {
  ...
  const caseStudies = [
    'Banking app - 2M users',
    'E-commerce redesign - 40% lift',
    'Design system - 500 components'
  ]
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-center gap-4">
        <Button
          variant={view === 'engineer' ? 'default' : 'outline'}
        ...
        <Button
          variant={view === 'designer' ? 'default' : 'outline'}
