...
const twStyles = {
  menubar: [
    "flex h-10 items-center space-x-1 rounded-md border border-neutral-200 bg-white p-1",
    "dark:border-neutral-800 dark:bg-neutral-950",
  ],
  menubarTrigger: [
    "flex cursor-default select-none items-center rounded-sm px-3 py-1.5 text-sm",
    "font-medium outline-none focus:bg-neutral-100 focus:text-neutral-900",
  ...
  menubarSubTrigger: [
    ...
    "outline-none focus:bg-neutral-100 focus:text-neutral-900 data-[state=open]:bg-neutral-100",
  ...
  menubarContent: [
    "z-50 min-w-[12rem] overflow-hidden rounded-md border border-neutral-200 bg-white p-1",
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(twStyles.menubar, className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(twStyles.menubarTrigger, className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.SubContent
    ref={ref}
    className={cn(twStyles.menubarSubContent, className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Separator
    ref={ref}
    className={cn(twStyles.menubarSeparator, className)}
    {...props}
  />
));
...
const MenubarShortcut = ({
  ...
  return (
    <span className={cn(twStyles.menubarShortcut, className)} {...props} />
  );
};
