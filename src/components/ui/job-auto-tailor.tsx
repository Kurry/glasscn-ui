    ...
    >
      <Card className="w-full max-w-lg" variant="glass" blur="lg">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-base">AI creates perfect-fit resumes</CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2 text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400">Enter any job posting URL and AI will:</p>
...
export function TailoredResumes({ variants, onSelectVariant, onMergeBest, className }: TailoredResumesProps) {
  return (
    <div
      className={cn(
        'min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 dark:from-gray-950 dark:to-gray-900 flex items-center justify-center p-4',
    ...
    >
      <Card className="w-full max-w-3xl" variant="glass" blur="lg">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-base">Each optimized for different aspects of the job</CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center justify-center gap-2">
                        <Progress value={variant.matchPercentage} className="h-1.5 w-16" />
                        <span
                          className={cn(
                            'text-sm font-semibold',
                            variant.matchPercentage >= 90
                              ? 'text-green-600'
                              : variant.matchPercentage >= 80
                                ? 'text-primary-600'
                                : 'text-yellow-600',
                          )}
                        >
          ...
          {onMergeBest && (
            <div className="text-center pt-4 mt-4 border-t border-gray-200 dark:border-gray-800">
              ...
              <Button onClick={onMergeBest} variant="outline" className="mx-auto">
                Merge Best Features
              </Button>
            </div>
          )}
...
export function JobAutoTailorDemo() {
  ...
  return (
    <div className="w-full">
      {stage === 'url' && <JobUrlInput onSubmit={handleUrlSubmit} />}
