      ...
      <Card className="w-full max-w-lg" variant="glass" blur="lg">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-4 border border-blue-200 dark:border-blue-900">
            <h3 className="font-medium text-blue-800 dark:text-blue-300 mb-2">AI will:</h3>
    ...
    <div className={cn('min-h-screen bg-gray-50 dark:bg-gray-900 p-4', className)}>
      <Card className="max-w-4xl mx-auto" variant="glass" blur="lg">
        ...
        <CardContent className="space-y-6">
            ...
            <CardContent className="p-4">
              ...
              <div className="h-32 flex items-center justify-center">
                <div className="text-center">
                  <p className="font-medium text-gray-700 dark:text-gray-300">{activeCompany} Application Form</p>
                  <p className="text-sm text-gray-500 mt-2">AI is completing the application...</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Card variant="solid" className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-900">
              <CardContent className="p-4 text-center">
                <div className="text-2xl font-bold text-blue-800 dark:text-blue-300">{totalToday}</div>
                <p className="text-sm text-blue-600 dark:text-blue-400">Applied Today</p>
              </CardContent>
            </Card>

            <Card variant="solid" className="bg-green-50 dark:bg-green-950/20 border-green-200 dark:border-green-900">
              <CardContent className="p-4 text-center">
                <div className="text-2xl font-bold text-green-800 dark:text-green-300">{responses}</div>
                <p className="text-sm text-green-600 dark:text-green-400">Responses</p>
              </CardContent>
            </Card>
          </div>
          ...
          {/* Recent Applications */}
          <div>
            <h3 className="font-medium text-gray-900 dark:text-white mb-3">Recent Applications:</h3>
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="flex-shrink-0">
                      ...
                      {app.status === 'scheduled' && <Clock className="w-5 h-5 text-yellow-500" />}
                    </div>
                    <div>
                      <p className="font-medium text-gray-900 dark:text-white">
                        {app.company} - {app.position}
                      </p>
                      {app.time && <p className="text-sm text-gray-500">{app.time}</p>}
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    {app.matchScore && <Badge variant="outline">{app.matchScore}% match</Badge>}
                  </div>
                </div>
              ))}
            </div>
