...
const twStyles = {
  ...
  list: [
    ...
    "text-neutral-500 dark:bg-gray-800 dark:text-neutral-400",
  ],
  trigger: [
    ...
    "disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-white",
    "data-[state=active]:text-neutral-950 data-[state=active]:shadow-sm",
    "dark:ring-offset-neutral-950 dark:focus-visible:ring-gray-300",
    "dark:data-[state=active]:bg-gray-950 dark:data-[state=active]:text-neutral-50",
  ],
  content: [
