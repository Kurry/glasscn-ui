      ...
      <Card className="w-full" variant="glass" blur="lg">
        <CardHeader className="pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <Badge className="mb-1 bg-green-100 text-green-800 border-green-200">
                Perfect Match Alert
              </Badge>
            ...
            <div className="p-3 bg-green-50 dark:bg-green-950/20 rounded-lg border border-green-200 dark:border-green-800">
              <div className="flex items-center gap-2 text-green-700 dark:text-green-300">
                ...
                <span className="font-medium">
                  AI automatically applied for you!
                </span>
              </div>
            </div>
          ) : (
      ...
      <Card className="w-full max-w-2xl" variant="glass" blur="lg">
        <CardHeader className="pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>
                AI is continuously scanning for perfect matches
              </CardDescription>
            </div>
          </div>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <Card variant="solid" className="bg-purple-50 dark:bg-purple-950/20 border-purple-200 dark:border-purple-800">
              <CardContent className="p-4 text-center">
