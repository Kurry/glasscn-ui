...
const twStyles = {
  ...
  resizeHandle: [
    'relative flex w-px items-center justify-center bg-gray-200 after:absolute',
    'after:inset-y-0 after:left-1/2 after:w-1 after:-translate-x-1/2 focus-visible:outline-none',
    'focus-visible:ring-1 focus-visible:ring-gray-950 focus-visible:ring-offset-1',
    ...
    'dark:bg-gray-800 dark:focus-visible:ring-gray-300',
  ],
  resizeHandleInner: [
    'z-10 flex h-4 w-3 items-center justify-center rounded-sm border border-gray-200',
    'bg-gray-200 dark:border-gray-800 dark:bg-gray-800',
  ],
  grip: 'h-2.5 w-2.5',
}

const ResizablePanelGroup = ({ className, ...props }: React.ComponentProps<typeof ResizablePrimitive.PanelGroup>) => (
  <ResizablePrimitive.PanelGroup className={cn(twStyles.panelGroup, className)} {...props} />
)
