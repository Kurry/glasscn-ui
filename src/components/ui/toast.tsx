...
const twStyles = {
  ...
  action: [
    ...
    "group-[.destructive]:border-neutral-100/40 group-[.destructive]:hover:border-red-500/30",
    "group-[.destructive]:hover:bg-red-500 group-[.destructive]:hover:text-neutral-50",
    "group-[.destructive]:focus:ring-red-500 dark:border-neutral-800 dark:ring-offset-neutral-950",
    "dark:hover:bg-neutral-800 dark:focus:ring-neutral-300",
    "dark:group-[.destructive]:border-neutral-800/40 dark:group-[.destructive]:hover:border-red-900/30",
    "dark:group-[.destructive]:hover:bg-red-900 dark:group-[.destructive]:hover:text-neutral-50",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(twStyles.viewport, className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(twStyles.action, className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(twStyles.close, className)}
    toast-close=""
    {...props}
  >
