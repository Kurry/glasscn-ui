        ...
        <CardHeader>
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <CardDescription className="text-base text-gray-700 dark:text-gray-300">{message}</CardDescription>
            </div>
          </div>
        </CardHeader>
...
export function FeatureReminder({ featureName, onSetupFeature, className }: FeatureReminderProps) {
  return (
    <ReEngagement
...
export function ReEngagementEmail({ subject, recipientName, children, className }: ReEngagementEmailProps) {
  return (
