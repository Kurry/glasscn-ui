...
const enhanceButton = cva(
  'inline-flex items-center justify-center font-semibold transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed hover:-translate-y-0.5 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-600 dark:focus-visible:ring-blue-500',
  {
    variants: {
      variant: {
        primary:
          'bg-blue-600 text-white shadow-lg shadow-blue-600/25 hover:bg-blue-700 hover:shadow-blue-600/30 dark:bg-blue-600 dark:hover:bg-blue-700',
        outline:
          'bg-white/75 backdrop-blur-lg ring-1 ring-blue-200 text-blue-700 hover:bg-blue-50 hover:ring-blue-300 dark:bg-gray-900/75 dark:ring-blue-800 dark:text-blue-400 dark:hover:bg-blue-950/50',
      },
      size: {
...
export function EnhanceButton({
  ...
  return (
    <button
      ...
      {...props}
    >
      <Sparkle className={cn(size === 'sm' ? 'w-4 h-4' : size === 'lg' ? 'w-6 h-6' : 'w-5 h-5')} />
