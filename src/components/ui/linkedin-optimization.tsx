      ...
      <Card className="w-full max-w-2xl" variant="glass" blur="lg">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>AI keeping profiles consistent</CardDescription>
              </div>
            </div>
        ...
        <CardContent className="space-y-6">
          ...
          {results && (
            ...
            >
              <CardContent className="p-4">
                <h3 className="font-medium text-indigo-800 dark:text-indigo-300 mb-3">Results:</h3>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  {results.endorsements && (
                    <div className="text-center">
                      ...
                      <p className="text-sm text-indigo-600 dark:text-indigo-400">Skill endorsements</p>
                    </div>
                  )}
                </div>
              </CardContent>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            {onSyncProfiles && (
              <Button onClick={onSyncProfiles} variant="outline" className="flex-1">
                Sync Other Profiles
              </Button>
            )}
          </div>
